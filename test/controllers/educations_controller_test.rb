...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference("Education.count") do
      post educations_url, params: { education: { stage: @education.stage, university: @education.university, user_id: @education.user_id } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { stage: @education.stage, university: @education.university, user_id: @education.user_id } }
